...
RegisterNUICallback('escape', function(data, cb)
    ...
    TriggerEvent("note:CloseNotepad")
end)
...
RegisterNetEvent("note:OpenNotepadGui")
AddEventHandler("note:OpenNotepadGui", function()
    if not isUiOpen then
        openGui()
    end
end)

RegisterNetEvent("note:CloseNotepad")
AddEventHandler("note:CloseNotepad", function()
    SendNUIMessage({
        action = 'closeNotepad'
    })
...
RegisterNetEvent('note:note')
AddEventHandler('note:note', function()
...
RegisterNetEvent('note:updateNotes')
AddEventHandler('note:updateNotes', function(serverNotesPassed)
